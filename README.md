...
Then you can type `sae help` to see the brief usage info, for more information on sae checkout [Eq.yml structure](docs/Eq.yml-Structure.md) and [Usage](docs/Usage.md)
